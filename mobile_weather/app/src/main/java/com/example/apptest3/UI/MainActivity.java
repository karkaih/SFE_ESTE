...
public class MainActivity extends AppCompatActivity {
    ...
    public static String city_pass;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_floating.setOnClickListener(v -> {
            //hide Keyboard
            ...
            city_pass = search.getText().toString();
        });

        findViewById(R.id.floatingActionButton).setOnClickListener(v->startActivity(new Intent(getApplicationContext(),AllWeek.class)));
    }
    private void api_key(final String City) {
        OkHttpClient client=new OkHttpClient();

        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=4fb4a7ce04bfdac5a90209896600dfa9&units=metric")
                .get()
                .build();
